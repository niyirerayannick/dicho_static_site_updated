...
class OrderAdmin(admin.ModelAdmin):
    list_display = ("order_number", "full_name", "phone", "total", "payment_method", "status", "created_at")
    ...
    def mark_pending(self, request, queryset): queryset.update(status=Order.Status.PENDING)
    ...
    actions = ("mark_pending", "mark_confirmed", "mark_processing", "mark_delivered", "mark_cancelled")
