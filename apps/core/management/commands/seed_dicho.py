...
REAL_PRODUCTS = [
    ...
    {"name": "ALVI Lemongrass Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 10000, "image": "new/Lemongrass essential oil.png", "short_description": "Lemongrass essential oil for aromatic use and formulations.", "description": "ALVI Lemongrass Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Lemongrass essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
    {"name": "ALVI Eucalyptus Citriodola Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 9000, "image": "new/Eucalyptus Citriodola essential oil.png", "short_description": "Eucalyptus citriodola essential oil for aromatic use and formulations.", "description": "ALVI Eucalyptus Citriodola Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Eucalyptus citriodola essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
    {"name": "ALVI Patchouli Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 12000, "image": "new/Patchouli essential oil.png", "short_description": "Patchouli essential oil for aromatic use and formulations.", "description": "ALVI Patchouli Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Patchouli essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
    {"name": "ALVI Geranium Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 12000, "image": "categories/aromatherapy-essential-oils.png", "short_description": "Geranium essential oil for aromatic use and formulations.", "description": "ALVI Geranium Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Geranium essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
    {"name": "ALVI Lavender Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 12000, "image": "categories/aromatherapy-essential-oils.png", "short_description": "Lavender essential oil for aromatic use and formulations.", "description": "ALVI Lavender Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Lavender essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
    {"name": "ALVI Eucalyptus maideni Essential Oil", "category": "Aromatherapy & Essential Oils", "size": "15 ml", "price": 9000, "image": "categories/aromatherapy-essential-oils.png", "short_description": "Eucalyptus maideni essential oil for aromatic use and formulations.", "description": "ALVI Eucalyptus maideni Essential Oil is a carefully packaged essential oil for aromatic use and selected formulations.", "benefits": "Aromatic essential oil for everyday product and fragrance use.", "ingredients": "Eucalyptus maideni essential oil; see product label for details.", "usage": "Use according to the product label. Keep away from eyes and follow safe dilution guidance.", "is_new": True, "is_featured": False},
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for index, data in enumerate(REAL_PRODUCTS):
            ...
            defaults = {"name": data["name"], "category": categories[data["category"]], "short_description": data["short_description"], "description": data["description"], "benefits": data["benefits"], "ingredients": data["ingredients"], "usage_instruction": data["usage"], "size": data["size"], "price": data["price"], "old_price": None, "image": product_image, "asset_path": "", "is_active": True, "is_featured": data.get("is_featured", True), "is_new": data.get("is_new", index < 7), "is_best_seller": index in (3, 6, 10), "is_on_sale": False}
