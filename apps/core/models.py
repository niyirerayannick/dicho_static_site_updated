...
class SiteSetting(models.Model):
    ...
    phone = models.CharField(max_length=50, default="0788428711 / 0783285278")
    email = models.EmailField(default="info@dicho.rw")
    whatsapp_number = models.CharField(max_length=30, default="0788428711")
    address = models.CharField(max_length=255, default="Huye, Rwanda")
